...
<body>
    ...
    <h1 style="color: aquamarine;">Bem Vindo!</h1> 
    <h2 style="color: aquamarine;">Filmes e series:</h2>
    <hr>
     <div> <button id="adicionarfilmes" onclick="window.location.href='../adicionar/adicionar.php'">Adicionar Filmes</button></div>
